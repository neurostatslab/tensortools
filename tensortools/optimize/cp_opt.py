...
def cp_opt(X, rank=None, method='Newton-CG', random_state=None, **options):
    ...
    Notes
    -----
    Experimental - This implemenation is using the optimization methods.
    ...
    while(success == False):        
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        res = minimize(cp_opt_fun, np.ravel(U), args=(X, normX, U_shape, result), method=method, 
                                jac=True, hess=None, 
                                hessp=None, bounds=None, constraints=(), 
                                tol=result.tol, callback=None, 
